...
OBJDoc.prototype.parseFace = function(sp, materialName, vertices, reverse) {  
  ...
  // Calculate the surface normal and set it to normal
  var normal = calcNormal(v0, v1, v2);
  // Check if the normal was found correctly
  if (normal == null) {
    if (face.vIndices.length >= 4) { // If the face is a quadrilateral calculate the normal by another combination of 3 points
      var v3 = [
    ...
    if(normal == null){         // Since the normal was not obtained it is assumed to be the Y-axis normal
      normal = [0.0, 1.0, 0.0];
    }
  }
  if(reverse){
